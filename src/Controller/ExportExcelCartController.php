...
class ExportExcelCartController extends AbstractController
{
    private $session;
    ...
    private function getData(): array
    {
        ...
        foreach ($cart as $id => $quantity) {
            $list[] = [
                'name' => $this->articleRepository->find($id)->getName(),
                'designation' => $this->articleRepository->find($id)->getName(),
                'quantity' => $quantity
            ];
        }
        return $list;
     ...
     * @Route("/panier/excel",  name="cart_excel")
     * @throws Exception
